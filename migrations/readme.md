...
Здесь должна лежать версия схемы БД. Миграции описывают все таблицы, индексы, foreign keys и constraints, которые поддерживают инварианты из корневого плана.
