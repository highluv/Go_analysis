...
-- Нормализованная модель. Поддерживает этап 1.3 (normalize).
-- Инварианты: I4–I7 (уникальность сущностей в snapshot), I9 (один key лейбла на объект).

-- +goose Up

-- Глобальный интернированный словарь пар key/value (дедуп по всей БД).
